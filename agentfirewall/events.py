...
class EventLog:
    ...
    def __init__(self, path: Optional[str | Path] = "agentfirewall.jsonl") -> None:
...
def dashboard(path: str | Path = "agentfirewall.jsonl") -> str:
    ...
    lines = [
        f"agentfirewall - {total} events from {p}",
        "-" * 48,
...
if __name__ == "__main__":
    ...
    print(dashboard(sys.argv[1] if len(sys.argv) > 1 else "agentfirewall.jsonl"))
